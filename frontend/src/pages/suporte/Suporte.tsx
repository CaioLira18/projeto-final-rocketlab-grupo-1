          ...
          {loading && tickets.length === 0 ? (
            ...
            <div className="p-12 text-center text-gray-400 font-medium space-y-2">
              ...
              {filtrosAtivos > 0 && (
                <button
                  ...
                  className="text-sm text-action hover:underline font-semibold cursor-pointer block mx-auto animate-fade-in"
                >
            ...
            <>
              <div className="overflow-x-auto relative">
                {loading && (
                  <div className="absolute inset-0 bg-white/40 backdrop-blur-[0.5px] flex items-center justify-center z-10 transition-opacity duration-200">
